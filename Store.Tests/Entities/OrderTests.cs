...
namespace Store.Tests.Entities
{
    ...
    public class OrderTests
    {
        ...
        public OrderTests()
        {
            _customer = new Customer("Antonio", "Sucre");
            _product = new Product("Produto", 10, true);
            _discount = new Discount(5, DateTime.Now.AddDays(3));
        ...
        {
            var order = new Order(_customer, 5, _discount);
        ...
        {
            var order = new Order(_customer, 10, new Discount(10, DateTime.Now));
            order.AddItem(_product, 5);
        ...
        {
            var order = new Order(_customer, 10, new Discount(10, DateTime.Now.AddDays(3)));
            order.AddItem(_product, 5);
            Assert.AreEqual(50, order.Total());
        }
